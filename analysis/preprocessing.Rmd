...
Dieses Dokument beschreibt die Vorprozessierung und explorative Analyse des Datensatzes, der unter [srf.ch interaktiv visualisiert](http://www.srf.ch/news/schweiz/schweiz-bewilligt-millionendeal-mit-dem-irak) und unter [diesem Link](http://www.srfcdn.ch/srf-data/data/2017/seco-dual-use/data/seco_dual_use.csv) als CSV-Datei zum Download angeboten wird.
...
Das zugrunde liegende Script sowie die prozessierten Daten können unter [diesem Link](https://srfdata.github.io/2017-01-dual-use/rscript.zip) heruntergeladen werden. Durch Ausführen von `preprocessing.Rmd` kann der hier beschriebene Prozess nachvollzogen und dieses Dokument generiert werden. Dabei werden Daten aus dem Ordner `input` eingelesen und Ergebnisse in den Ordner `output` geschrieben. 

#### GitHub

Der Code für die vorliegende Datenprozessierung und die [Visualisierung](http://www.srfcdn.ch/srf-data/data/2017/seco-dual-use/) ist unter [https://github.com/srfdata/2017-01-dual-use](https://github.com/srfdata/2017-01-dual-use) zur freien Verwendung verfügbar. 
...
Der Datensatz für das Jahr 2016 findet sich auf der neuen [Übersichtsseite](https://www.seco.admin.ch/seco/de/home/Aussenwirtschaftspolitik_Wirtschaftliche_Zusammenarbeit/Wirtschaftsbeziehungen/exportkontrollen-und-sanktionen/industrieprodukte--dual-use--und-besondere-militaerische-gueter/statistik/2015.html) unter dem Reiter 2016 -> im Ordner `input/elic_2016_*.xlsx`. Er ist auf vier Excel-Files (für jedes Quartal) aufgesplittet.
